% test_adjoint
clear;
fprintf('This code checks the Adjoint.\n')
...
Jdq = lsqr_op_domain(dq,'notransp',X,Y,GG,k,sensors,q,u_tot);
Ndata = length(Jdq);
...
Jadj = lsqr_op_domain(umeas,'transp',X,Y,GG,k,sensors,q,u_tot);
Jadj = reshape(Jadj,N,N).*dq;
l2Rsum = trap2d(Jadj);
